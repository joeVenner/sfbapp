...
const Navbar = () => {
    ...
    return ( 
        <header className="relative h-14 py-1 px-10  flex justify-between shadow-[0_0.2rem_0.7rem_0px_rgba(0,0,0,0.14)] shadow-[rgba(0,0,0,0.14)_0px_0.2rem _0.7rem_0px]" aria-label="primary navigation" >
                ...
                { !menuOpen && <button className="absolute right-10 top-3 md:hidden" onClick={toggleClick} id="open">
                ...
                { menuOpen && <button className="absolute right-10 top-3  md:hidden"  id="close" onClick={toggleClick}>
